...
export default function AddUser() {
    ...
    const {
        ...
        error: userError,
    } = useSWR("http://localhost:4000/users/", async (url) => axios.get(url));
    ...
    return (
        <main className="h-screen flex items-center justify-center">
            ...
            <div className="container">
                <section className="flex items-center justify-center gap-10 pt-12 pr-5">
                    <div className="relative">
                        ...
                        {/* shapes */}
                        <div className="absolute -top-12 -left-16 w-28 h-28 bg-green-500 shadow-[0_0_1rem_#22c55e] rounded-full -z-10"></div>
                        <div className="absolute -bottom-20 -right-20 w-32 h-32 bg-green-500 shadow-[0_0_1rem_#22c55e] rounded-full -z-10"></div>
                        {/* form */}
                        <Formik
            ...
            <div
                ...
                } right-0 left-0 flex items-center justify-center h-14 font-vazir-medium bg-green-500 transition-all`}
            >
                ثبت نام موفقیت آمیز بود . در صورتی که نمیخواهید حساب جدیدی ایجاد
                کنید دکمه بازگشت به صفحه اصلی را بزنید.
            </div>
        </main>
    );
}
