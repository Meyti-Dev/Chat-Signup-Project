        ...
        <>
            ...
            {pathname === "/" && (
                <button
                    ...
                    className="fixed top-0 bottom-0 left-0 flex items-center justify-center w-7 h-10 bg-zinc-700 my-auto rounded-tr-xl rounded-br-xl border border-solid border-white/10"
                >
            ...
            {pathname === "/" && (
                ...
                >
                    <div
                        ...
                        className={`fixed top-0 bottom-0 flex items-center justify-between flex-col gap-5 w-96 bg-zinc-700 p-5 border-r border-solid border-white/10 z-50 ${
